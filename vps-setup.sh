...
echo "   1. No Portainer: criar Stack com o compose"
echo "   2. No Portainer: configurar env vars (TOKEN_1, TOKEN_2, TAILSCALE_IP)"
echo "   3. No Portainer: deploy da stack"
echo "   4. No Portainer Console: rodar onboarding em cada instancia"
echo ""
